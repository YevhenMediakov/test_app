...
class _$ProfileDataCopyWithImpl<$Res, $Val extends ProfileData>
  ...
  @pragma('vm:prefer-inline')
  $ProfileAddressCopyWith<$Res> get address {
    return $ProfileAddressCopyWith<$Res>(_value.address, (value) {
  ...
  @pragma('vm:prefer-inline')
  $ProfileCompanyCopyWith<$Res> get company {
    return $ProfileCompanyCopyWith<$Res>(_value.company, (value) {
...
class _$ProfileDataImpl extends _ProfileData {
  ...
  @override
  String toString() {
    return 'ProfileData(id: $id, name: $name, username: $username, email: $email, address: $address, phone: $phone, website: $website, company: $company)';
  }
...
abstract class _ProfileData extends ProfileData {
  const factory _ProfileData(
      ...
      required final ProfileAddress address,
...
mixin _$ProfileCompany {
  ...
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $ProfileCompanyCopyWith<ProfileCompany> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ProfileCompanyCopyWith<$Res> {
...
/// @nodoc
class _$ProfileCompanyCopyWithImpl<$Res, $Val extends ProfileCompany>
    implements $ProfileCompanyCopyWith<$Res> {
  _$ProfileCompanyCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ProfileCompanyImplCopyWith<$Res>
    implements $ProfileCompanyCopyWith<$Res> {
...
/// @nodoc
class __$$ProfileCompanyImplCopyWithImpl<$Res>
    extends _$ProfileCompanyCopyWithImpl<$Res, _$ProfileCompanyImpl>
    implements _$$ProfileCompanyImplCopyWith<$Res> {
  __$$ProfileCompanyImplCopyWithImpl(
      _$ProfileCompanyImpl _value, $Res Function(_$ProfileCompanyImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ProfileCompanyImpl(
      name: null == name
          ? _value.name
          : name // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$ProfileCompanyImpl extends _ProfileCompany {
  const _$ProfileCompanyImpl(
  ...
  @override
  String toString() {
    return 'ProfileCompany(name: $name, catchPhrase: $catchPhrase, bs: $bs)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ProfileCompanyImplCopyWith<_$ProfileCompanyImpl> get copyWith =>
      __$$ProfileCompanyImplCopyWithImpl<_$ProfileCompanyImpl>(
          this, _$identity);
}

abstract class _ProfileCompany extends ProfileCompany {
  const factory _ProfileCompany(
      {required final String name,
...
mixin _$ProfileAddress {
  ...
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $ProfileAddressCopyWith<ProfileAddress> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ProfileAddressCopyWith<$Res> {
...
/// @nodoc
class _$ProfileAddressCopyWithImpl<$Res, $Val extends ProfileAddress>
    implements $ProfileAddressCopyWith<$Res> {
  _$ProfileAddressCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ProfileAddressImplCopyWith<$Res>
    implements $ProfileAddressCopyWith<$Res> {
...
/// @nodoc
class __$$ProfileAddressImplCopyWithImpl<$Res>
    extends _$ProfileAddressCopyWithImpl<$Res, _$ProfileAddressImpl>
    implements _$$ProfileAddressImplCopyWith<$Res> {
  __$$ProfileAddressImplCopyWithImpl(
      _$ProfileAddressImpl _value, $Res Function(_$ProfileAddressImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ProfileAddressImpl(
      street: null == street
          ? _value.street
          : street // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$ProfileAddressImpl extends _ProfileAddress {
  const _$ProfileAddressImpl(
  ...
  @override
  String toString() {
    return 'ProfileAddress(street: $street, suite: $suite, city: $city, zipcode: $zipcode)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ProfileAddressImplCopyWith<_$ProfileAddressImpl> get copyWith =>
      __$$ProfileAddressImplCopyWithImpl<_$ProfileAddressImpl>(
          this, _$identity);
}

abstract class _ProfileAddress extends ProfileAddress {
  const factory _ProfileAddress(
...
class _$GeoImpl extends _Geo {
  const _$GeoImpl({required this.lat, required this.lng}) : super._();
